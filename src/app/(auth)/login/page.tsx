  ...
  return (
    <div className="space-y-8">
      <div className="text-center space-y-4">
        <div className="mx-auto h-20 w-20 relative rounded-[24px] shadow-bento overflow-hidden flex items-center justify-center bg-card border border-border/70">
          <Image src="/logo.png" alt="Relincho" fill sizes="80px" className="object-contain p-2" priority />
        </div>
        <div>
